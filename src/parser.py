...
parser.add_argument("-m_dis", "--max_dishonest", default=3, type=int, help="Assumed maximum number of dishonest nodes")
parser.add_argument("-tz", "--t_zero", default=0, type=int, help="Protocol start time")
parser.add_argument("-e", "--epochs", default=None, type=int, help="Number of epochs to run (unlimited by default)")
